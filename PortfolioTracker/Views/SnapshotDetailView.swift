                    ...
                    if sortedCategories.isEmpty {
                        ...
                        VStack(spacing: 0) {
                            ...
                            ForEach(sortedCategories) { catSnap in
                                ...
                                // Category Header Row (Expandable)
                                Button {
                                    withAnimation {
                                        if isExpanded {
                                ...
                                // Asset rows under this category (visible only if expanded)
                                if isExpanded {
                                        ...
                                        VStack(spacing: 0) {
                                            HStack(spacing: 0) {
                                                VStack(alignment: .leading, spacing: 4) {
                                                    ...
                                                    // Units and original currency if it is not INR
                                                ...
                                                .frame(maxWidth: .infinity, alignment: .leading)
                                                .padding(.leading, 20) // Indent asset rows
